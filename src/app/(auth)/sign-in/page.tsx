...
export default function SignInPage() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        console.log("Sign in:", formData, { rememberMe });
    };
        ...
        <div>
            <div className="mb-8">
                ...
                <p className="mt-2 text-sm text-tertiary">
                    Sign in to your Coreverus account to continue.
                </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="relative">
                    ...
                    <div className="relative flex justify-center">
                        <span className="bg-white px-4 text-sm text-tertiary">or continue with</span>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                    <button
                        type="button"
                        className="flex items-center justify-center gap-2 rounded-lg border border-secondary bg-primary px-4 py-2.5 text-sm font-medium text-secondary shadow-xs transition-colors hover:bg-gray-50"
                    >
